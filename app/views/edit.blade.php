...
@section('content')
<form method="POST" action="/reviews/{{{$reviewtoedit->slug}}}/edit" class="form-horizontal col-lg-8 col-lg-offset-3">
	...
	<div class="form-group">
		<textarea name="body" id="editor1">{{$reviewtoedit->body}}</textarea>
	</div>
	<div class="form-group">
